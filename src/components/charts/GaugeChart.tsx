...
export default function GaugeChartPreview() {
  ...
  const vc = customization.visualCustomizations?.gaugeChart || {};
  ...
  return (
    <div style={{
      ...
      <svg width={240} height={130} viewBox="0 0 240 130">
        ...
        <path d={`M ${bgStart.x} ${bgStart.y} A ${r} ${r} 0 ${largeArc} 1 ${valEnd.x} ${valEnd.y}`} fill="none" stroke={fillColor} strokeWidth={thickness} />
        {(() => {
